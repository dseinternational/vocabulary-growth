...
- We use **Bayesian** models: each quantity comes with a full probability distribution.
  We quote a **best estimate** plus a **credible interval** — the range the true value
  lies in with a stated probability. A **90%** interval is our usual summary; a **95%**
  interval is wider (more cautious). If an interval includes the "no-difference" value,
  we cannot claim a difference.
...
| ----- | ---------------------------------- | ---------------------------------- |
| 24 mo | **101** (90% 82–121; 95% 79–126)   | **5** (90% 3–7; 95% 3–8)           |
| 48 mo | **281** (90% 240–323; 95% 232–333) | **147** (90% 115–179; 95% 110–186) |
| 72 mo | **444** (90% 377–513; 95% 365–527) | **371** (90% 318–424; 95% 307–435) |
...
| Age   | q (%)                          |
| ----- | ------------------------------ |
| 24 mo | **5%** (90% 3–7; 95% 3–8)      |
| 48 mo | **53%** (90% 43–62; 95% 41–64) |
| 72 mo | **84%** (90% 73–95; 95% 70–96) |
...
- **TD understood: ~357 words** (90% 303–411; 95% 288–425)
- **DS understood: ~101 words** (90% 82–121; 95% 79–126)
...
| ----- | ------ | ------------------------------ | ------------------------------ |
| 36 mo | 41     | **107** (90% 78–135)           | **+65** (90% 41–89; 95% 37–96) |
| 48 mo | 143    | **188** (90% 151–223)          | **+44** (90% 24–63; 95% 22–69) |

The estimated sign–speech association **psi = 1.8** (90% 1.2–2.3; 95% 1.1–2.5) — a
...
| --------------------------------- | -------------------------------------- | -------------------------------------- |
| signer vs non-signer              | OR 1.11 (90% 0.89–1.37; 95% 0.86–1.44) | OR 0.93 (90% 0.74–1.17; 95% 0.71–1.22) |
...
**small and positive**: `beta_lag` = **+0.20** on the logit scale (90% 0.06–0.33; 95%
0.04–0.36; 99% of the posterior above 0). **Plain reading:** understanding earlier is
...
`model_vg17.py`/`model_vg18.py`). Intervals are highest-density (HDI) credible intervals
from the fitted posteriors. Methods + convergence: `202607121753-...md`._
