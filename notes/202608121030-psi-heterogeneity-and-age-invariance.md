...
> **Second correction (2026-09-02, Claude Code/Fable 5.1, re [202609021903](202609021903-es01-gesture-construct-revisited.md)):** the 2026-08-28 correction above over-corrected in its turn. The coding claim in the original subsection stands; the "different construct" claim is retracted to _not established_ — es_01's definition includes taught signs and spontaneous gestures alike, and the sign sources' columns carry no recorded definition, so the distinction cannot be drawn on either side. The subsection's final sentence is therefore neither confirmed nor refuted: the between-source spread is unexplained, with what was counted, es_01's category coverage (the eleven-category elimination, plausibly directional toward independence) and signing instruction all candidates of unknown size. §§3–8 stand.
