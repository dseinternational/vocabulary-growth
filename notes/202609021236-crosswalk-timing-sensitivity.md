...
> [!IMPORTANT]
> Correction added on 23 September 2026 with assistance from OpenAI Codex/GPT-6. A simulated fraction of 1.00 is not proof of probability one. Timing sensitivity does not verify nested item content across forms and languages. Apparent reversals can reflect content and sample differences as well as administration noise. See the [statistical review corrections](202609231200-statistical-review-corrections.md). The original interpretation below remains as a dated record.
