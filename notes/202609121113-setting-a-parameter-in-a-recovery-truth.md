...
> [!IMPORTANT]
> Correction added on 23 September 2026 with assistance from OpenAI Codex/GPT-6. The independent recovery transform changes all three correlations together. That design can assess the joint change, but cannot isolate the effect of the sign-speech correlation alone. See the [statistical review corrections](202609231200-statistical-review-corrections.md). The original interpretation below remains as a dated record.
