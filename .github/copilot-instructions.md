...
| VG15  | Words understood + spoken + signed (joint, four-cell) | Down syndrome        | Within-understood sign-speech association `psi` (Plackett copula, identified from the uk_02 four-cell cross-tab) + study & subject random intercepts + GP anchor (VG10 stabilisation); data-identified `p_any` replaces VG14's independence upper bound |
