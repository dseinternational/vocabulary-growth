...
We jointly model words understood, words spoken and words signed as bounded count outcomes out of 810 possible words. The expected proportion of words understood, $p_U(a)$, is modelled as a smooth function of age using a linear trend plus a Gaussian process on the logit scale.
