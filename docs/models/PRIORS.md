...
¹ Scored against VG11 at `eta_sigma` 0.5. This result, with the convergence it bought (`notes/202608142000` §5c), is the evidence on which VG11 adopted `eta_sigma` 0.4 on 2026-09-16 (#357, `notes/202609161440-vg11-eta-sigma-0.4.md`). The arm is now registered the other way round, as `eta-wide` at 0.5, and has not been fitted under that name.
