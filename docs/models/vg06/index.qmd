---
title: "Model VG06: Joint model of words understood and spoken - typically developing children"
...
This model jointly examines how age influences words understood and words spoken ($A \rightarrow U$, $A \rightarrow S$, $U \rightarrow S$) in typically developing children, using a production-ratio reparameterization that enforces $p_S \leq p_U$ by construction.
...
![Posterior predictive production ratio](production_rate_predictive.svg){#fig-production-rate-predictive .lightbox fig-align="left"}
