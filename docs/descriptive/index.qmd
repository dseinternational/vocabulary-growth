...
Each row of the source data is one **parent-report checklist administration** for one child at one age: counts of words *understood* and *spoken* (and, for the signing sub-set, words *signed*), harmonised onto the common 810-item reference inventory. Children measured repeatedly contribute several rows, so observations exceed children. The current pooled sample comprises **1,800 observations of 957 children across fifteen international studies, spanning ages 8–115 months** — 1,260 observations record words understood, 1,421 words spoken, and 899 words signed. The fifteenth, `us_03`, entered on 2026-09-05 and contributes comprehension only: its expressive cell is a produced union of speech and sign that no spoken count can be recovered from (see `data/vocab_data_us_03.md`). Per-study detail is in @tbl-inventory; the figures then plot the raw observations, one colour per study.
